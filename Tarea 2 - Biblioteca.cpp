...
void cargarLibros() {
    ...
    libros[0][0] = "Algoritmos"; libros[0][1] = "Algoritmos y Programación (Guía para docentes)"; libros[0][2] = "Sheridan Le Fanu";
    libros[1][0] = "Algoritmos"; libros[1][1] = "Apuntes de Algoritmos y Estructuras de Datos"; libros[1][2] = "Sergio Luján Mora";
    libros[2][0] = "Algoritmos"; libros[2][1] = "Breves Notas sobre Análisis de Algoritmos"; libros[2][2] = "Lovecraft";
    ...
    libros[9][0] = "Base de Datos"; libros[9][1] = "Base de Datos Avanzadas (2013)"; libros[9][2] = "Sergio Luján Mora";
    ...
    libros[12][0] = "Ciencia Computacional"; libros[12][1] = "Breves Notas sobre Teoria de la Computación"; libros[12][2] = "Lovecraft";
    libros[13][0] = "Metodologias de desarrollo de software"; libros[13][1] = "Compendio de Ingeniería del Software"; libros[13][2] = "Lovecraft";
	libros[14][0] = "Metodologias de desarrollo de software"; libros[14][1] = "Diseno agil con TDD"; libros[14][2] = "Moore";
    libros[15][0] = "Metodologias de desarrollo de software"; libros[15][1] = "Ingeniería de Software: Una Guía para Crear Sistemas de Información"; libros[15][2] = "Bill Gates";
    ...
    libros[18][0] = "Miscelaneos"; libros[18][1] = "97 cosas que todo programador deberia saber"; libros[18][2] = "Sergio Luján Mora";
    ...
    libros[22][0] = "Miscelaneos"; libros[22][1] = "Programación de videojuegos SDL"; libros[22][2] = "Sergio Luján Mora";
    ...
    libros[25][0] = "PHP"; libros[25][1] = "POO y MVC en PHP"; libros[26][2] = "Sergio Luján Mora";
    libros[26][0] = "PHP"; libros[26][1] = "Silex, el manual oficial"; libros[27][2] = "Sergio Luján Mora";
    libros[27][0] = "PHP"; libros[27][1] = "Symfony 1.4, la guía definitiva"; libros[28][2] = "Ada de Lovelace";
    ...
    libros[31][0] = "Python"; libros[31][1] = "Inmersión en Python"; libros[32][2] = "Greydi Avila";
    libros[32][0] = "Python"; libros[32][1] = "Inmersión en Python 3"; libros[33][2] = "Willemina Fleming";
